...
- 변경 파일:
  - AGENTS.md: §30–§41 신규 추가(Pull Request First, 의미 있는 변경 단위, Issue 기반 개발, 독립 리뷰, PR 품질, 공개 저장소 완성도, 릴리스 완료, Upstream 기여, GitHub 지표 무결성, 자동화 규칙, 완료 기준, 의사결정 우선순위). §2·§21에 PR First 화해 문구, §22에 §34/§30 참조 추가
...
- 결과: 성공
- 후속 작업: Pull Request First 기본값을 모든 저장소에 적용할지, 공개·공유 저장소로 한정할지 사용자 확인 필요
